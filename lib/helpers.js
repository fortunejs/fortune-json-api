...
function initializeContext (context, request) {
  ...
  const inputMethods = this.inputMethods
  ...
  const UnsupportedError = errors.UnsupportedError
  ...
  const serializerInput = context.request.serializerInput
  ...
  const type = context.request.type = uriObject.type ? inflectType ?
