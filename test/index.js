...
run(() => {
  ...
  return test(`/animals?${qs.stringify({
    ...
    ok(~response.body.links.first.indexOf('page[offset]=0'), 'first link is correct')
    ok(~response.body.links.last.indexOf('page[offset]=4'), 'last link is correct')
    ok(~response.body.links.next.indexOf('page[offset]=1'), 'next link is correct')
...
run(() => {
  ...
  return test(`/animals?${qs.stringify({
    ...
    ok(~response.body.links.first.indexOf('page[offset]=0'), 'first link is correct')
    ok(~response.body.links.last.indexOf('page[offset]=4'), 'last link is correct')
    ok(~response.body.links.next.indexOf('page[offset]=2'), 'next link is correct')
    ok(~response.body.links.prev.indexOf('page[offset]=0'), 'prev link is correct')
  })
})
...
run(() => {
  ...
  return test(`/animals?${qs.stringify({
    ...
    ok(~response.body.links.prev.indexOf('page[offset]=3'), 'prev link is correct')
  })
})
